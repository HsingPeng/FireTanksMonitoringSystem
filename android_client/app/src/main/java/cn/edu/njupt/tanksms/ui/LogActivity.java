...
public class LogActivity extends BaseActivity {
    ...
    private void sendTask() {
        ...
        intent.putExtra(Config.ACTION_FLAG,Config.ACTION_GET_LOG);
        startService(intent);
    }

    private void setWebView() {
        webView = (WebView)findViewById(R.id.webView_log);
        ...
        WebChromeClient client = new WebChromeClient(){
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                MyDialog dialog = new MyDialog(LogActivity.this,"",message);
            ...
            public boolean onJsConfirm(WebView view, String url, String message, final JsResult result) {
                ...
                dialog.addCancelButton(LogActivity.this.getString(R.string.cancel), new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        result.cancel();
                    }
    ...
    protected String[] onReceive(Context context, Intent intent) {
        ...
        return new String[]{Config.LOG_ACTIVITY_RECEIVER};
    }

    private void handleGetLog(Intent intent) {
