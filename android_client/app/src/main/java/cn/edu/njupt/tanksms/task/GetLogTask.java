 ...
 */
public class GetLogTask extends BaseTask {

    private static final String TAG = "GetLogTask";
    ...
    public void run() {
        ...
        HttpUtils http = new HttpUtils(Config.URL+Config.URL_LOG,context, new HttpUtils.HttpCallBack() {
            @Override
    ...
    private String handlePage(String data) {
        int need_start = data.indexOf("<!-- BEGIN LIST-->");
        int need_end = data.indexOf("<!-- END LIST-->");
    ...
    private void setBroadcast(String[] result_text) {
        ...
        intent.setAction(Config.LOG_ACTIVITY_RECEIVER);
